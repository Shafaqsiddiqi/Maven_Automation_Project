...
public class Reusable_Actions_Hasan {
    ...
    public static void sendActions (WebDriver driver, String xpath, String userValue, String elementName) {
        WebDriverWait wait = new WebDriverWait(driver,8);
        try {
            WebElement element = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath)));
            element.click();
    ...
    public static void sendIndexActions (WebDriver driver, String xpath,int indexNumber, String userValue, String elementName) {
        WebDriverWait wait = new WebDriverWait(driver,8);
        try {
            WebElement element = wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.xpath(xpath))).get(indexNumber);
            element.click();
