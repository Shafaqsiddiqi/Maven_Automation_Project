...
public class Reusable_Actions_loggers_POM_Hasan {
    ...
    public static void sendActions(WebDriver driver, WebElement xpath, String userValue, ExtentTest logger, String elementName) {
        WebDriverWait wait = new WebDriverWait(driver, 8);
        try {
            WebElement element = wait.until(ExpectedConditions.visibilityOf(xpath));
            element.click();
    ...
    public static void getScreenShot(WebDriver driver, String imageName, ExtentTest logger) {
        try {
            ...
            String snPath = null;
            directory = "src/main/java/Hasan_HTML_Report/Screenshots/";
            snPath = "Screenshots//";
